...
# with command line options: step2 -s DIGI:pdigi_valid,L1TrackTrigger,L1,L1P2GT,DIGI2RAW,HLT:@relval2026 --conditions auto:phase2_realistic_T33 --datatier GEN-SIM-DIGI-RAW -n 10 --eventcontent FEVTDEBUGHLT --geometry Extended2026D110 --era Phase2C17I13M9 --procModifiers alpaka --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C17I13M9_cff import Phase2C17I13M9
from Configuration.ProcessModifiers.alpaka_cff import alpaka

process = cms.Process('reHLT',Phase2C17I13M9,alpaka)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_DIGI_L1TrackTrigger_L1_L1P2GT_DIGI2RAW_HLT.root'),
...
#process.repacker = cms.Path(process.rawPrimeDataRepacker)
# Schedule definition
...
#process.schedule.insert(47,process.repacker)
