...
public:
  ...
  float barycenter() const { 
    ...
    return _barycenter; }
  cms_uint8_t width() const {return std::min(255,(int)width_);}//return std::min(255,(int)width_);}//return std::min(255,(int)width_);}//return std::min(255,(int)width_);}//return std::min(255,(int)width_);}//return std::min(255,(int)width_);}//return std::min(255,(int)width_);// return std::min(7,(int)width_); }
...
private:
  ...
  static constexpr double maxRange_ = 65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //65535; //255;
