...
# with command line options: step_reco --conditions 150X_dataRun3_Prompt_v1 -s RAW2DIGI,L1Reco,RECO --datatier RECO --eventcontent RECO --data --process reRECO --scenario pp -n -1 --repacked --era Run3_pp_on_PbPb_approxSiStripClusters_2025 --filein file:step2_L1REPACK_HLT_wdnn.root --no_exec --nThreads 50
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step_reco nevts:-1'),
