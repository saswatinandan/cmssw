...
private:
  ...
  edm::EDGetTokenT<edmNew::DetSetVector<SiPixelCluster>> hltPixelclustersToken_;
  ...
  int         charge;
  uint16_t         prev_clus_size;
  uint16_t         next_clus_size;
  int         prev_clus_charge;
  int         next_clus_charge;
  int         prev_clus_idx;
  int         next_clus_idx; 
...
void nn_tupleProducer_raw::create_tree() {
  ...
  */
  ...
  tree->Branch("prev_clus_size", &prev_clus_size, "prev_clus_size/s");
  tree->Branch("next_clus_size", &next_clus_size, "next_clus_size/s");
  tree->Branch("prev_clus_charge", &prev_clus_charge, "prev_clus_charge/I");
  tree->Branch("next_clus_charge", &next_clus_charge, "next_clus_charge/I");
  tree->Branch("prev_clus_idx", &prev_clus_idx, "prev_clus_idx/I");
  tree->Branch("next_clus_idx", &next_clus_idx, "next_clus_idx/I");
  ...
  tree->Branch("mean_x", &mean_x, "mean_x/F");
  tree->Branch("mean_y", &mean_y, "mean_y/F");
...
void nn_tupleProducer_raw::initialize_vars() {
   ...
   prev_clus_size = prev_clus_charge = prev_clus_idx = next_clus_size = next_clus_charge = next_clus_idx = 0;
