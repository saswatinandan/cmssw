...
# with command line options: SingleMuPt10_Eta2p85_cfi -s GEN,SIM -n 100 --conditions auto:phase1_2025_realistic --beamspot DBrealistic --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3_2025 --relval 9000,100 --fileout file:step1.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SingleMuPt10_Eta2p85_cfi nevts:100'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_muon_woPU_3to10.root'),
