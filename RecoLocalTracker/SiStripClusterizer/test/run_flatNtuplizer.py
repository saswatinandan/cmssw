...
os.system(f'cmsRun sep19_2_2_dump_raw.py inputFiles={input_for_raw} outputFile={output_for_raw} n={options.n}')

input_for_rawp = options.input_rawp
output_for_rawp = f'flatntuple_{input_for_rawp}'
os.system(f'cmsRun sep19_2_1_dump_rawprime.py inputFiles={input_for_rawp} outputFile={output_for_rawp} n={options.n}')
