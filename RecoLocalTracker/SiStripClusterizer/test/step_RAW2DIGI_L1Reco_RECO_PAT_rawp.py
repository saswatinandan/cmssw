...
# with command line options: test --conditions 150X_dataRun3_Prompt_v1 -s RAW2DIGI,L1Reco,RECO,PAT --datatier RECO --eventcontent MINIAOD --data --process reRECO --scenario pp -n -1 --repacked --era Run3_2025 --filein file:step2_L1REPACK_HLT_wdnn.root --no_exec --nThreads 50 --era Run3_pp_on_PbPb_approxSiStripClusters_2025 --hltProcess reHLT
...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('file:/scratch/nandan/inputfile_for_prehlt/ephemeral_physics_raw/wdnn/step2/step2_L1REPACK_HLT_1.root'),
...
process.siStripClusters = cms.EDProducer("SiStripApprox2Clusters",
...
process.options.numberOfThreads = 130
