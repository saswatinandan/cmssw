...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2_wPU.root'),
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_wPU.root'),
    outputCommands = process.RECOEventContent.outputCommands + ['keep *_hltMergedTracks_*_*'],
