...
# with command line options: step2_wPU_Pion --conditions auto:phase1_2025_realistic --datatier GEN-SIM-DIGI-RAW --era Run3_2025 --eventcontent FEVTDEBUGHLT --filein file:step1.root --fileout file:step2.root --geometry DB:Extended --nStreams 1 --nThreads 8 --no_exec --number 10 --pileup Run3_Flat55To75_PoissonOOTPU --pileup_input das:/RelValMinBias_14TeV/CMSSW_15_1_0-151X_mcRun3_2025_realistic_v4_STD_MinBias_2025_GenSim-v1/GEN-SIM --python_filename step_2_cfg.py --step DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2025
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2_wPU_Pion nevts:10'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step2_wPU.root'),
