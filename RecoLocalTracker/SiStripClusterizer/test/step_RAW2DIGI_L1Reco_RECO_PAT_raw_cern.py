...
# with command line options: test --conditions 150X_dataRun3_Prompt_v1 -s RAW2DIGI,L1Reco,RECO,PAT --datatier RECO --eventcontent MINIAOD --data --process reRECO --scenario pp -n -1 --filein file:step2_L1REPACK_HLT_wdnn.root --no_exec --nThreads 50 --era Run3_pp_on_PbPb_approxSiStripClusters_2025 --hltProcess reHLT
...
process.options = cms.untracked.PSet(
    ...
    numberOfThreads = cms.untracked.uint32(130),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_raw.root'),
