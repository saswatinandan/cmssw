...
parser.add_argument("-r", dest="bit", default='8bit', help="bit to be studied")

options = parser.parse_args()
bit = options.bit

def replace_line(infile, to_replaces, vals):
...
cmd_hlt = 'hltGetConfiguration /users/vmuralee/PREmenu/V9 --globaltag 140X_dataRun3_HLT_for2024TSGStudies_v1 --data --unprescale --max-events 100 --eras Run3 --input /store/data/Run2024F/Muon0/RAW-RECO/ZMu-PromptReco-v1/000/382/216/00000/aadd1ab9-4eb8-4fb2-ac62-bdd1bebe882e.root > prehlt.py'
...
replace_line('step2_REPACK.py', 
              ['Run3_pp_on_PbPb_approxSiStripClusters', 'step2_REPACK.root'], ['Run3_pp_on_PbPb_approxSiStripClusters_2024', f'step2_REPACK_{bit}.root'])
...
replace_line('step3_RAW2DIGI_L1Reco_RECO.py',
             ['Run3_pp_on_PbPb_approxSiStripClusters', 'step3_RAW2DIGI_L1Reco_RECO.root'], ['Run3_pp_on_PbPb_approxSiStripClusters_2024', f'step3_RAW2DIGI_L1Reco_RECO_{bit}.root'])
