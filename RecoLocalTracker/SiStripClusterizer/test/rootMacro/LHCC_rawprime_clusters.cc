...
struct test{
	...
	{
		if (in_expTag=="LHCC_run374345_ls29_small") 
		{
			cout << "run374345 ls29 (small)" << endl;
			f1name = "../output/LHCC_run374345_ls29_HIExpressPhysicsRawPrime_FEVT_small_sep19_2_2_dump_raw.root";
			f2name = "../output/LHCC_run374345_ls29_HIExpressPhysics_FEVT_small_sep19_2_2_dump_raw.root";
			f3name = "../output/LHCC_run374345_ls29_HIExpressPhysicsRawPrime_FEVT_small_sep19_3_2_dump_raw.root";
			f4name = "../output/LHCC_run374345_ls29_HIExpressPhysics_FEVT_small_sep19_3_2_dump_raw.root";
		} else if (in_expTag=="LHCC_run374345_ls29") 
		{
			cout << "run374345 ls29" << endl;
			f1name = "../output/LHCC_run374345_ls29_HIExpressPhysicsRawPrime_FEVT_sep19_2_2_dump_raw.root";
			f2name = "../output/LHCC_run374345_ls29_HIExpressPhysics_FEVT_sep19_2_2_dump_raw.root";
			f3name = "../output/LHCC_run374345_ls29_HIExpressPhysicsRawPrime_FEVT_sep19_3_2_dump_raw.root";
			f4name = "../output/LHCC_run374345_ls29_HIExpressPhysics_FEVT_sep19_3_2_dump_raw.root";
		}
	}
};
...
int main(int argc, char const *argv[])
{
	...
	TTree* onlineClusterTree= (TTree*) _1->Get("offlineClusterTree");
