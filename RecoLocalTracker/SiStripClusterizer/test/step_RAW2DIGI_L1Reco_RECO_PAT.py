...
# with command line options: step --conditions 150X_dataRun3_Prompt_v1 -s RAW2DIGI,L1Reco,RECO,PAT --datatier RECO --eventcontent MINIAOD --data --process reRECO --scenario pp -n -1 --filein file:step2_L1REPACK_HLT_wdnn.root --no_exec --nThreads 50 --era Run3_2025
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step nevts:-1'),
    name = cms.untracked.string('Applications'),
    version = cms.untracked.string('$Revision: 1.19 $')
)
#process.siStripClusters.Clusterizer.clusterChargeCut.value='SiStripClusterChargeCutTight'
# Output definition
