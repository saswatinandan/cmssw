...
def build_array(obj, rawtype):
  ...
  update_list('pp_wochargecut', 16, 8, rawtype, sizes, yvals, texts, "HI_raw'_nochargecut", options.events)
  ...
  update_list('pp_wchargecut', 16, 8, rawtype, sizes, yvals, texts, "HI_raw'_withchargecut", options.events)
